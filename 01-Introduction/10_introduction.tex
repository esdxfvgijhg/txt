...
\begin{frame}{LoRa modulation}{Physical layer \cite{eriksson_investigating_2017}}
\begin{align}
\textbf{LoRa}=                                       & \frac{2^{S F}}{B W}\left((N P+4.25)+\left(S W+\max \left(\left\lceil\frac{8 PS-4 S F+28+16 C R C-20 I H}{4(S F-2 D E)}\right](C R+4), 0\right)\right)\right)\\
